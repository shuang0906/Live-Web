...
io.sockets.on('connection', function (socket) {
		...
		const userName = usernames[0]//Math.floor(Math.random() * usernames.length)]//.splice(Math.floor(Math.random() * usernames.length), 1)[0]; // This also removes the name from the array to avoid duplicates
