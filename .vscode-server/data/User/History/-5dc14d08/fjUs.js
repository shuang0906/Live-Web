//Hi Daniel! Currently the code is structured with standalone functions, 
// but I’m wondering if it would be better to refactor it using classes. 
// Would using classes to manage canvases, cursors, and interactions or 
// would it add unnecessary complexity in this case? I'd love to hear your thoughts on the best approach.
...
function setupAndDrawCanvas(canvasId, dotDatas) {
    ...
    canvas.addEventListener('click', (event) => {
        ...
        const closeDot = closeToDot(x, y, dots);
